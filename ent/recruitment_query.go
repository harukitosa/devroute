...
func (rq *RecruitmentQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (rq *RecruitmentQuery) FirstIDX(ctx context.Context) int {
...
func (rq *RecruitmentQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (rq *RecruitmentQuery) OnlyIDX(ctx context.Context) int {
...
func (rq *RecruitmentQuery) IDs(ctx context.Context) ([]int, error) {
	var ids []int
...
func (rq *RecruitmentQuery) IDsX(ctx context.Context) []int {
	ids, err := rq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(recruitment.FieldTitle).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
//
