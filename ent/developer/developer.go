...
const (
	// Label holds the string label denoting the developer type in the database.
	Label = "developer"
	...
	FieldGender = "gender"
	// Table holds the table name of the developer in the database.
	Table = "developers"
)

// Columns holds all SQL columns for developer fields.
var Columns = []string{
	FieldID,
	FieldLastName,
	FieldFirstName,
...
func GenderValidator(ge Gender) error {
	...
	case GenderMale, GenderFemale, GenderOther:
		return nil
	default:
		return fmt.Errorf("developer: invalid enum value for gender field: %q", ge)
	}
}
