...
func (cu *CompanyUpdate) SetPostalCode(s string) *CompanyUpdate {
...
func (cu *CompanyUpdate) SetCompanyID(s string) *CompanyUpdate {
	cu.mutation.SetCompanyID(s)
	return cu
}

// SetIntroduction sets the "introduction" field.
func (cu *CompanyUpdate) SetIntroduction(s string) *CompanyUpdate {
...
// SetPostalCode sets the "postal_code" field.
func (cuo *CompanyUpdateOne) SetPostalCode(s string) *CompanyUpdateOne {
...
// SetCompanyID sets the "company_id" field.
func (cuo *CompanyUpdateOne) SetCompanyID(s string) *CompanyUpdateOne {
	cuo.mutation.SetCompanyID(s)
	return cuo
}

// SetIntroduction sets the "introduction" field.
func (cuo *CompanyUpdateOne) SetIntroduction(s string) *CompanyUpdateOne {
