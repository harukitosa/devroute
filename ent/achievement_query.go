...
// Returns a *NotSingularError when exactly one Achievement entity is not found.
...
// Returns a *NotSingularError when exactly one Achievement ID is not found.
...
//		GroupBy(achievement.FieldTitle).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
//
